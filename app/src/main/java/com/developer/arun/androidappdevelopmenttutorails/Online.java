...
public class Online extends AppCompatActivity {
    ...
    private void parseJSON() {
        ...
        String url1 ="https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLrnPJCHvNZuCPNCW2xdriIUgxmo9-QcFi&key=AIzaSyAygs57QVux81pihKTo5dmpPb5hSId3g5I";
        final String url2 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&pageToken=CDIQAA&playlistId=PLrnPJCHvNZuCPNCW2xdriIUgxmo9-QcFi&key=AIzaSyAygs57QVux81pihKTo5dmpPb5hSId3g5I";
                ...
                JsonObjectRequest jsonObjectRequest1=new JsonObjectRequest(Request.Method.GET, url2, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            adapter=new ExampleAdapter(Online.this,mexamplelist);
