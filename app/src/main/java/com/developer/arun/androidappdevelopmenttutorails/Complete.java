...
public class Complete extends AppCompatActivity {
    ...
    private void parseJSON() {
        ...
        String url1 ="https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLM8gmU39ZoDf892ojedRLLr9yVzytRr27&key=AIzaSyAygs57QVux81pihKTo5dmpPb5hSId3g5I";
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url1, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapter=new ExampleAdapter(Complete.this,mexamplelist);
